...
import com.audiorec.memomic.android.TimeFormat;
import com.audiorec.memomic.android.Views;
...
public class SaidItFragment extends Fragment {
    ...
    private class RecordButtonClickListener implements View.OnClickListener, View.OnLongClickListener {
        ...
        float getPrependedSeconds(View button) {
            int id = button.getId();
            if (id == R.id.record_last_minute) {
                return 60;
            } else if (id == R.id.record_last_5_minutes) {
                return 60 * 5;
            } else if (id == R.id.record_last_30_minutes) {
                return 60 * 30;
            } else if (id == R.id.record_last_2_hrs) {
                return 60 * 60 * 2;
            } else if (id == R.id.record_last_6_hrs) {
                return 60 * 60 * 6;
            } else if (id == R.id.record_last_max) {
                return 60 * 60 * 24 * 365;
            }
            return 0;
        }
    ...
    static Notification buildNotificationForFile(Context context, File outFile) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, YOUR_NOTIFICATION_CHANNEL_ID)
                ...
                .setSmallIcon(R.mipmap.ic_stat_notify_recorded)
